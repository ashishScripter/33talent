...
//implement dropdown search
  ...
  $model = new JobTestimonialUser;
     ...
     * @return type
     */
    public function updateResume($file, $model, $job_id, $employ_id, $type = null,$catarray =null) {
        ...
        if ($file_tmp && is_object($file_tmp) && get_class($file_tmp) === 'CUploadedFile') {
            ...
            $resume->id_category        = $catarray['catid'];
            $resume->id_subcategories   = $catarray['subcatid'];
            $resume->type               = $type;
...
//insert to db
    ...
    public function actionRegisterCV() {
        ...
        if (isset($_POST['JobEmployees']) && $_POST['JobEmployees']) {
            ...
            $catarray['catid']      = $_POST['cat_id'];
            $catarray['subcatid']   = $_POST['sub_cat_id'];
            ...
            if ($model_tmp) {
                ...
                if ($model_update->save()) {
                    $this->updateResume($_POST['JobResumes']['file_id'], $resume, 0, $employ_id, 2,$catarray);
                }
            } else {
                ...
                if ($model->save()) {
                    ...
                    $this->updateResume($_POST['JobResumes']['file_id'], $resume, 0, $model->employ_id, 2,$catarray); //2 for register cv
                }
            }
...
//        
    ...
    public function actionRegisterAlert() {
        ...
        if (isset($_POST['JobEmployees']) && $_POST['JobEmployees']) {
            ...
            Yii::app()->user->setFlash('success', "Thank You for Signing Up for Job Alerts at 33Talent!");
            $this->redirect(array('page/index#message-info'));
        }
