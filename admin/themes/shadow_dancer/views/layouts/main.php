                        ...
                        array('label' => 'Job Management','url' =>'#',
                            'items' => array(
                                array('label' => 'Category', 'url' => '#', 'items' => array(
                                        ...
                                        array('label' => 'Manage Category', 'url' => array('/JobCategories/index')),
                                    )),
                                array('label' => 'Jobs', 'url' => '#', 'items' => array(
                                        array('label' => 'Create Jobs', 'url' => array('/Jobs/create')),
                                        array('label' => 'Manage Jobs', 'url' => array('/Jobs/index')),
                                    )),
                                array('label' => 'WorkType', 'url' => '#', 'items' => array(
                                        array('label' => 'Create WorkType', 'url' => array('/JobWorktype/create')),
                                        array('label' => 'Manage WorkType', 'url' => array('/JobWorktype/index')),
                                    )),
                                array('label' => 'Job Location', 'url' => '#', 'items' => array(
                                        array('label' => 'Create WorkType', 'url' => array('/JobLocation/create')),
                                        array('label' => 'Manage WorkType', 'url' => array('/JobLocation/index')),
                                    )),
                            ),
                        ),
