 ...
 * @property integer $hiring_organization_id
...
class Jobs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('base_salary, date_posted, experience_requirements, hiring_organization_id, job_location_id, qualifications, responsibilities, salary_currency, skills, special_commitments, title, work_hours', 'required'),
			array('cat_id, base_salary, hiring_organization_id, job_location_id', 'numerical', 'integerOnly'=>true),
			array('benefits, education_requirements, incentives, industry, qualifications, responsibilities, salary_currency, skills, special_commitments, title, work_hours', 'length', 'max'=>255),
			array('experience_requirements', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cat_id, job_id, base_salary, benefits, date_posted, education_requirements, experience_requirements, hiring_organization_id, incentives, industry, job_location_id, qualifications, responsibilities, salary_currency, skills, special_commitments, title, work_hours', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'cat_id' => 'Category relation',
			'job_id' => 'Job',
			'base_salary' => 'The base salary of the job',
			...
			'hiring_organization_id' => 'Organization offering the job position.',
			...
			'salary_currency' => 'The currency (coded using ISO 4217, http://en.wikipedia.org/wiki/ISO_4217 used for the main salary information in this job posting.',
	...
	public function search()
	{
		...
		$criteria->compare('hiring_organization_id',$this->hiring_organization_id);
