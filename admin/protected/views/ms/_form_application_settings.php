...
<div class="form">
    ...
    <div class="row">
        ...
        <?php
        echo CHtml::dropDownList('APPLICATION_STATUS[value6_int]', Ms::model()->findByAttributes(array('var_name' => 'APPLICATION_STATUS'))->value6_int, array('1' => 'Active', '0' => 'Inactive', '2' => 'Expired'), array("onChange" => "toggleStatusBox()"));
        ?>	   
    </div>     
...
<?php
echo CHtml::dropDownList('APPLICATION_TIMEZONE[value1]', Ms::model()->findByAttributes(array('var_name' => 'APPLICATION_TIMEZONE'))->value1, array('' => 'Default', 'Singapore' => 'Singapore', 'India' => 'India'));
?>	   
    </div>      
...
<?php
echo CHtml::dropDownList('ALLOW_BLOCK_USERS[value6_int]', Ms::model()->findByAttributes(array('var_name' => 'ALLOW_BLOCK_USERS'))->value6_int, array('1' => 'Allow All Users', '2' => 'Allow Selected Users', '3' => 'Block Selected Users'), array("onChange" => "toggleAllowBlockBox()"));
?>	   
    </div>     
    ...
    <div class="row">
        ...
        <?php
        echo CHtml::dropDownList('MOBILE_PHONES_STATUS[value6_int]', Ms::model()->findByAttributes(array('var_name' => 'MOBILE_PHONES_STATUS'))->value6_int, array('1' => 'Default', '2' => 'Show Custom HTML'), array("onChange" => "toggleMobilePhonesBox()"));
        ?>	   
    </div>     
