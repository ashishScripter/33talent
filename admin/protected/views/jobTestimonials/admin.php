...
?>
<?php
 $base_path_tmp = Yii::app()->getBaseUrl('/'); 
 $base_path = explode('admin',$base_path_tmp);
 $path_image =  $base_path[0];
    ...
    'columns' => array(
        ...
        'email',
         array(
             'name'=>'approved',
             'type'=>'raw',
             'value'=> "CHtml::link('Active',CHtml::normalizeUrl(array('JobTestimonialUser/approved', 'id'=>\$data->testimonial_user_id)))"
